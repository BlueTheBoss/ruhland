    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string manageUser: "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'systemsettings' 'gnome-control-center'"
                ...
                property string taskManager: "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'gnome-system-monitor' 'plasma-systemmonitor' 'btop'"
                property string terminal: "~/.config/hypr/hyprland/scripts/launch_first_available.sh 'kitty -1' 'foot' 'alacritty' 'wezterm' 'konsole' 'kgx' 'uxterm' 'xterm'"
